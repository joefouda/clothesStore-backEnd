...
const mainListRouter = require('./modules/mainLists/mainListsRouter')
const addressRouter = require('./modules/addresses/addressRouter')
...
app.use(`${api}/mainList`, mainListRouter)
