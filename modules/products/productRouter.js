...
const {add, update, getAllProducts, queryProductByName, getProductsByCategoryName,getProductsBySubCategoryName, getProductsByModel, getProductById, getProductByModelAndSpecs} = require('./productController')
